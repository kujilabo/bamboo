module github.com/kujilabo/bamboo/bamboo-app2

go 1.21.0

require (
	github.com/kujilabo/bamboo/bamboo-request-controller v0.0.0-20230904160728-84348442b1b7
	github.com/kujilabo/bamboo/lib v0.0.0-20230904154652-31db6208c7a4
...
require (
	...
	github.com/kujilabo/cocotola/lib v0.0.0-20230103151530-04b30421bd09 // indirect
