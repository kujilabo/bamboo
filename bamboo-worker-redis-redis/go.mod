module github.com/kujilabo/bamboo/bamboo-worker-redis-redis

go 1.21.1

require (
	github.com/kujilabo/bamboo/bamboo-lib v0.0.0-20230921172353-34e7f5c75971
	github.com/kujilabo/bamboo/lib v0.0.0-20230921172353-34e7f5c75971
